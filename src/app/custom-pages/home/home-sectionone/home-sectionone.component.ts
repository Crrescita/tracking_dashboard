...
@Component({
  selector: "app-home-sectionone",
  templateUrl: "./home-sectionone.component.html",
  styleUrls: ["./home-sectionone.component.scss"],
})
export class HomeSectiononeComponent implements OnInit {
  ...
  getHeading() {
    ...
    this.api.get("home-getHeading", "section-one-heading").subscribe(
      (res: any) => {
  ...
  createFormData() {
    const formData = {
      ...
      sub_title: "",
      section_key: "section-one-heading",
    };
    return formData;
  }

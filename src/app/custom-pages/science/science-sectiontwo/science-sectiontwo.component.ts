...
@Component({
  selector: "app-science-sectiontwo",

  templateUrl: "./science-sectiontwo.component.html",
  styleUrl: "./science-sectiontwo.component.scss",
})
export class ScienceSectiontwoComponent implements OnInit {
  ...
  getData() {
    ...
    this.api.get("get-science-section", "section-two").subscribe(
      (res: any) => {
  ...
  createFormData(): FormData {
    ...
    formData.append("section_key", "section-two");

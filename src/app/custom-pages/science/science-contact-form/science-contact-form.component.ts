...
@Component({
  selector: "app-science-contact-form",
  templateUrl: "./science-contact-form.component.html",
  styleUrl: "./science-contact-form.component.scss",
})
export class ScienceContactFormComponent implements OnInit {
  ...
  getData() {
    ...
    this.api.get("form-data", "science").subscribe(
      (res: any) => {
  ...
  addSection(formData: FormData) {
    this.api.post("add-form-data", formData).subscribe(
      (res: any) => {
        this.reset();
  ...
  updateSection(formData: FormData) {
    ...
    this.api.put("add-form-data", urlId, formData).subscribe(
  ...
  createFormData(): FormData {
    ...
    formData.append("type", "science");
    formData.append("heading", this.s2["heading"].value);

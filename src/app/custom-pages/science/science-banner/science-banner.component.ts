...
@Component({
  selector: "app-science-banner",
  templateUrl: "./science-banner.component.html",
  styleUrl: "./science-banner.component.scss",
})
export class ScienceBannerComponent implements OnInit {
  formGroup!: FormGroup;
  ...
  getData() {
    ...
    this.api.getwithoutid("get-science-banner").subscribe(
      (res: any) => {
        ...
        if (res && res.status && res.data && res.data.length > 0) {
          ...
          this.id = data.id;
          this.uploadedImageOne = data.banner;
  ...
  addSection(formData: FormData) {
    this.api.post("insert-science-banner", formData).subscribe(
      (res: any) => {
        this.reset();
  ...
  updateSection(formData: FormData) {
    ...
    this.api.put("insert-science-banner", urlId, formData).subscribe(
  ...
  createFormData(): FormData {
    ...
    if (this.selectedImageOne) {
      formData.append("banner", this.selectedImageOne);
    }

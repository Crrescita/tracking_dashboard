...
@Component({
  selector: "app-science-sectionsix",
  templateUrl: "./science-sectionsix.component.html",
  styleUrl: "./science-sectionsix.component.scss",
})
export class ScienceSectionsixComponent implements OnInit {
  ...
  getData() {
    ...
    this.api.get("get-science-section", "section-six").subscribe(
      (res: any) => {
  ...
  createFormData(): FormData {
    ...
    formData.append("section_key", "section-six");

...
@Component({
  selector: "app-science-sectionfour",

  templateUrl: "./science-sectionfour.component.html",
  styleUrl: "./science-sectionfour.component.scss",
})
export class ScienceSectionfourComponent implements OnInit {
  ...
  getData() {
    ...
    this.api.get("get-science-section", "section-four").subscribe(
      (res: any) => {
  ...
  createFormData(): FormData {
    ...
    formData.append("section_key", "section-four");

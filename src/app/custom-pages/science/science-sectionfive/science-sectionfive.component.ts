...
@Component({
  selector: "app-science-sectionfive",
  templateUrl: "./science-sectionfive.component.html",
  styleUrl: "./science-sectionfive.component.scss",
})
export class ScienceSectionfiveComponent implements OnInit {
  ...
  getData() {
    ...
    this.api.get("get-science-section", "section-five").subscribe(
      (res: any) => {
  ...
  createFormData(): FormData {
    ...
    formData.append("section_key", "section-five");

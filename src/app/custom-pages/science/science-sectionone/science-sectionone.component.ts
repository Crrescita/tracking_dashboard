...
@Component({
  selector: "app-science-sectionone",
  templateUrl: "./science-sectionone.component.html",
  styleUrl: "./science-sectionone.component.scss",
})
export class ScienceSectiononeComponent implements OnInit {
  ...
  getData() {
    ...
    this.api.get("get-science-section", "section-one").subscribe(
      (res: any) => {
  ...
  createFormData(): FormData {
    ...
    formData.append("section_key", "section-one");

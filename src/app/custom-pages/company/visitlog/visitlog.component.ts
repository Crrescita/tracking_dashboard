...
@Component({
  ...
  styleUrl: './visitlog.component.scss'
})
export class VisitlogComponent {
breadCrumbItems!: Array<{}>;
  ...
  getquatationData() {
    this.toggleSpinner(true);
    const url = `visitLogs?company_id=${this.company_id}`;
    ...
    if (this.term) {
      filteredData = filteredData.filter(
        (el: any) =>
          ...
          el.emp_mobile.toLowerCase().includes(this.term.toLowerCase()) ||
          el.emp_email.toLowerCase().includes(this.term.toLowerCase()) ||
          el.visit_email.toLowerCase().includes(this.term.toLowerCase()) ||
          el.visit_mobile.toLowerCase().includes(this.term.toLowerCase())
      );

...
export class AboutBannerComponent implements OnInit {
  ...
  getData() {
    ...
    this.api.getwithoutid("get-about-banner").subscribe(
      (res: any) => {
  ...
  addSection(formData: FormData) {
    this.api.post("insert-about-banner", formData).subscribe(
      (res: any) => {
        this.reset();
  ...
  updateSection(formData: FormData) {
    ...
    this.api.put("insert-about-banner", urlId, formData).subscribe(

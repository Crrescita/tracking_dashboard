...
export const MENUORIGNAL: MenuItem[] = [
  {
    id: 1,
...
export const MENU: MenuItem[] = [
  ...
  {
    id: 78,
    label: "MENUITEMS.EXTRAPAGES.LIST.ABOUT",
    link: "/about",
    parentId: 78,
  ...
  {
    id: 80,
    label: "MENUITEMS.EXTRAPAGES.LIST.SERVICES",
    link: "/service",
    parentId: 80,
  ...
  {
    id: 81,
    label: "MENUITEMS.EXTRAPAGES.LIST.SCIENCE",
    link: "/science",
    parentId: 80,
  ...
  {
    id: 83,
    label: "MENUITEMS.EXTRAPAGES.LIST.CONTACT",
    link: "/add-contact",
    parentId: 82,
  ...
  {
    id: 82,
    label: "MENUITEMS.EXTRAPAGES.LIST.LOCATION",
    link: "/location",
    parentId: 79,
  ...
  {
    id: 83,
    label: "MENUITEMS.EXTRAPAGES.LIST.TESTIMONIAL",
  ...
  {
    id: 84,
    label: "MENUITEMS.EXTRAPAGES.LIST.PRODUCT",
    icon: " ri-stack-line",
    subItems: [
      {
        id: 166,
        label: "MENUITEMS.EXTRAPAGES.LIST.ADDCATEGORY",
        link: "/products/add-category",
        parentId: 165,
      },
      {
        id: 167,
        label: "MENUITEMS.EXTRAPAGES.LIST.ADDSUBCATEGORY",
        link: "/products/add-sub-category",
        parentId: 165,
      },
      {
        id: 168,
        label: "MENUITEMS.EXTRAPAGES.LIST.ADDTAG",
        link: "/products/add-tag",
        parentId: 165,
      },
      {
        id: 169,
        label: "MENUITEMS.EXTRAPAGES.LIST.ADDPRODUCTS",
        link: "/products",
        parentId: 165,
      },
    ],
...
export const COMPANY_MENU: MenuItem[] = [
  ...
  // Add more company-specific items
];

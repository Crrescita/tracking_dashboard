...
export class SidebarComponent {
  ...
  ngOnInit(): void {
    ...
    this.menuItems = this.menuService.getMenu(this.userType);
  ...
  getUserType(): string {
    // Logic to get the user type, e.g., from a JWT token or auth service
    // For this example, let's assume we get it from local storage
